...
class Infointer(models.Model):   
    ...
    vhc_queue_length = models.FloatField()    
    wait_avrg = models.FloatField()

class trafficlightinfo(models.Model):   
    intersection_id = models.CharField(max_length=30)
    appr_id = models.CharField(max_length=30, primary_key=True)
    appr_name = models.CharField(max_length=80)
